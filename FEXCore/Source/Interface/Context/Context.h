...
public:
  ...
  FEXCore::IR::AOTIRCacheEntry* LoadAOTIRCacheEntry(FEXCore::Core::InternalThreadState* Thread, uintptr_t GuestRIP,
                                                    const fextl::string& Name, fextl::vector<uint8_t> FileId) override;
